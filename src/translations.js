export const translations = {
  en: {
    ...
    footer: { made: 'Made from Saint Petersburg with curiosity.', top: 'Back to top', note: '© 2026 Khalil Housheya' },
  },
  ar: {
  ...
  ru: {
    ...
    hero: {
      ...
      location: 'Санкт-Петербург, Россия', status: 'Открыт к предложениям в backend-разработке', portraitLabel: 'МЕСТО ДЛЯ ФОТО', stamp: 'ЛЮБОПЫТСТВО ВКЛЮЧЕНО', scroll: 'Листайте дальше',
    },
