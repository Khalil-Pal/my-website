export const translations = {
  en: {
    ...
    work: {
      ...
      projects: [
        ...
        { id: 'emilie', index: 'C / 03', tag: 'Design & branding · not a software project', title: 'Émilie Atelier', description: 'A creative design practice working under the L\'Art d\'Émilie mark — visual identity and logo work, event invitations, social media sets and UI/UX layouts for small brands and personal occasions. It sits here as design work, not engineering: it shapes how I think about interfaces, but there is no codebase behind it.', artLabel: 'ÉMILIE', stack: ['Branding', 'Logo design', 'Invitations', 'Social media', 'UI/UX'], linkLabel: 'See the work on Instagram', link: 'https://www.instagram.com/emilie.art4?igsi=MTlvdXpmdnd1eHYwdQ%3D%3D' },
      ],
    },
    skills: {
      kicker: '03 / toolkit',
  ...
  ar: {
    ...
    work: {
      ...
      projects: [
        ...
        { id: 'emilie', index: 'C / 03', tag: 'تصميم وهوية بصرية · ليس مشروعاً برمجياً', title: 'Émilie Atelier', description: 'ممارسة تصميم إبداعية تحت اسم L\'Art d\'Émilie — هوية بصرية وشعارات، ودعوات مناسبات، وحزم محتوى لوسائل التواصل، وتخطيطات واجهات لعلامات صغيرة ومناسبات شخصية. أدرجته هنا بوصفه عمل تصميم لا عمل هندسة: يشكّل طريقة تفكيري في الواجهات، لكن لا كود خلفه.', artLabel: 'ÉMILIE', stack: ['Branding', 'Logo design', 'Invitations', 'Social media', 'UI/UX'], linkLabel: 'شاهد الأعمال على Instagram', link: 'https://www.instagram.com/emilie.art4?igsi=MTlvdXpmdnd1eHYwdQ%3D%3D' },
      ],
    },
    skills: {
    ...
    contact: { kicker: '05 / دورك الآن', title: 'لنَبْنِ شيئاً مفيداً', text: 'منفتح على تعاونات مدروسة وتدريبات ومحادثات حول بناء أشياء تعمل.', telegram: 'قل مرحباً على تيليغرام', github: 'شاهد الكود على GitHub', email: 'البريد الإلكتروني', resume: 'السيرة الذاتية', emailMarker: 'استبدال: عنوان بريدك الإلكتروني' },
  ...
  ru: {
    ...
    contact: { kicker: '05 / теперь ваша очередь', title: 'Давайте создадим что-то полезное.', text: 'Открыт к вдумчивым коллаборациям, стажировкам и разговорам о работающих вещах.', telegram: 'Написать в Telegram', github: 'Посмотреть код на GitHub', email: 'Почта', resume: 'Резюме', emailMarker: 'ЗАМЕНИТЬ: ваш email' },
